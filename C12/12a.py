# Código de la clase 9: Planificación agregada
...
# Setting the Problem
prob = LpProblem("Aggregate_Production:Planning:_Fixed_Work_Force_Model", LpMinimize)
